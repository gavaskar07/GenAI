...
internal class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        LMKit.Licensing.LicenseManager.SetLicenseKey("019B2F0-180E3D-CE9583-8321E1-B2D000-000525-050719-913478-87938D-FD");
        ...
        // code to load JAVA_PROGRAMMING_Gavas
         WriteLineColor("Loading JAVA_PROGRAMMING_Gavas eBook...", ConsoleColor.Green);
         LoadEbook("JAVA_PROGRAMMING_Gavas.txt", "JAVA_PROGRAMMING_Gavas");
